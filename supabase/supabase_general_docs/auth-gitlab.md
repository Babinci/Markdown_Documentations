...
This guide explains how to set up GitLab Authentication for your Supabase project.

## Overview

Setting up GitLab logins for your application consists of 3 parts:

1. Create and configure a GitLab Application on [GitLab](https://gitlab.com/)
2. Add your GitLab Application keys to your [Supabase Project](https://supabase.com/dashboard)
